...
public class ApplicationResourceIT {
    ...
    private static final byte[] DEFAULT_STATUS_DESCRIPTION = TestUtil.createByteArray(1, "0");
    private static final byte[] UPDATED_STATUS_DESCRIPTION = TestUtil.createByteArray(1, "1");
    private static final String DEFAULT_STATUS_DESCRIPTION_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_STATUS_DESCRIPTION_CONTENT_TYPE = "image/png";
    ...
    private static final String DEFAULT_ACTIVE_PHASE = "AAAAAAAAAA";
    private static final String UPDATED_ACTIVE_PHASE = "BBBBBBBBBB";
    ...
    private static final byte[] DEFAULT_USER_TYPE_DESCRIPTION = TestUtil.createByteArray(1, "0");
    private static final byte[] UPDATED_USER_TYPE_DESCRIPTION = TestUtil.createByteArray(1, "1");
    private static final String DEFAULT_USER_TYPE_DESCRIPTION_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_USER_TYPE_DESCRIPTION_CONTENT_TYPE = "image/png";

    private static final String DEFAULT_USER_ROLE = "AAAAAAAAAA";
    private static final String UPDATED_USER_ROLE = "BBBBBBBBBB";

    private static final byte[] DEFAULT_APPLICATION_CRITERIA = TestUtil.createByteArray(1, "0");
    private static final byte[] UPDATED_APPLICATION_CRITERIA = TestUtil.createByteArray(1, "1");
    private static final String DEFAULT_APPLICATION_CRITERIA_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_APPLICATION_CRITERIA_CONTENT_TYPE = "image/png";

    private static final Long DEFAULT_APPLICATION_TYPE_ID = 1L;
    private static final Long UPDATED_APPLICATION_TYPE_ID = 2L;
    private static final Long SMALLER_APPLICATION_TYPE_ID = 1L - 1L;
    ...
    private static final Long DEFAULT_SYNCHED_ENTITY_ID = 1L;
    private static final Long UPDATED_SYNCHED_ENTITY_ID = 2L;
    private static final Long SMALLER_SYNCHED_ENTITY_ID = 1L - 1L;
    ...
    public static Application createEntity(EntityManager em) {
        Application application = new Application()
            ...
            .statusDescriptionContentType(DEFAULT_STATUS_DESCRIPTION_CONTENT_TYPE)
            ...
            .userTypeDescriptionContentType(DEFAULT_USER_TYPE_DESCRIPTION_CONTENT_TYPE)
            .userRole(DEFAULT_USER_ROLE)
            .applicationCriteria(DEFAULT_APPLICATION_CRITERIA)
            .applicationCriteriaContentType(DEFAULT_APPLICATION_CRITERIA_CONTENT_TYPE)
            .applicationTypeId(DEFAULT_APPLICATION_TYPE_ID)
            ...
            .synchedEntityId(DEFAULT_SYNCHED_ENTITY_ID);
        return application;
    }
    /**
    ...
    public static Application createUpdatedEntity(EntityManager em) {
        Application application = new Application()
            ...
            .statusDescriptionContentType(UPDATED_STATUS_DESCRIPTION_CONTENT_TYPE)
            ...
            .userTypeDescriptionContentType(UPDATED_USER_TYPE_DESCRIPTION_CONTENT_TYPE)
            .userRole(UPDATED_USER_ROLE)
            .applicationCriteria(UPDATED_APPLICATION_CRITERIA)
            .applicationCriteriaContentType(UPDATED_APPLICATION_CRITERIA_CONTENT_TYPE)
            .applicationTypeId(UPDATED_APPLICATION_TYPE_ID)
            ...
            .synchedEntityId(UPDATED_SYNCHED_ENTITY_ID);
        return application;
    }
    ...
    public void createApplication() throws Exception {
        ...
        assertThat(testApplication.getStatusDescriptionContentType()).isEqualTo(DEFAULT_STATUS_DESCRIPTION_CONTENT_TYPE);
        ...
        assertThat(testApplication.getUserTypeDescriptionContentType()).isEqualTo(DEFAULT_USER_TYPE_DESCRIPTION_CONTENT_TYPE);
        ...
        assertThat(testApplication.getApplicationCriteriaContentType()).isEqualTo(DEFAULT_APPLICATION_CRITERIA_CONTENT_TYPE);
        assertThat(testApplication.getApplicationTypeId()).isEqualTo(DEFAULT_APPLICATION_TYPE_ID);
        ...
        assertThat(testApplication.getSynchedEntityId()).isEqualTo(DEFAULT_SYNCHED_ENTITY_ID);
    }
    ...
    @Test
    @Transactional
    public void checkApplicationTypeIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = applicationRepository.findAll().size();
        // set the field null
        application.setApplicationTypeId(null);
    ...
    public void getAllApplications() throws Exception {
        ...
        restApplicationMockMvc.perform(get("/api/applications?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].statusDescriptionContentType").value(hasItem(DEFAULT_STATUS_DESCRIPTION_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].statusDescription").value(hasItem(Base64Utils.encodeToString(DEFAULT_STATUS_DESCRIPTION))))
            .andExpect(jsonPath("$.[*].statusDate").value(hasItem(DEFAULT_STATUS_DATE.toString())))
            .andExpect(jsonPath("$.[*].activePhase").value(hasItem(DEFAULT_ACTIVE_PHASE)))
            ...
            .andExpect(jsonPath("$.[*].userTypeDescriptionContentType").value(hasItem(DEFAULT_USER_TYPE_DESCRIPTION_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].userTypeDescription").value(hasItem(Base64Utils.encodeToString(DEFAULT_USER_TYPE_DESCRIPTION))))
            .andExpect(jsonPath("$.[*].userRole").value(hasItem(DEFAULT_USER_ROLE)))
            .andExpect(jsonPath("$.[*].applicationCriteriaContentType").value(hasItem(DEFAULT_APPLICATION_CRITERIA_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].applicationCriteria").value(hasItem(Base64Utils.encodeToString(DEFAULT_APPLICATION_CRITERIA))))
            .andExpect(jsonPath("$.[*].applicationTypeId").value(hasItem(DEFAULT_APPLICATION_TYPE_ID.intValue())))
            ...
            .andExpect(jsonPath("$.[*].synchedEntityId").value(hasItem(DEFAULT_SYNCHED_ENTITY_ID.intValue())));
    }
    ...
    public void getApplication() throws Exception {
        ...
        restApplicationMockMvc.perform(get("/api/applications/{id}", application.getId()))
            ...
            .andExpect(jsonPath("$.statusDescriptionContentType").value(DEFAULT_STATUS_DESCRIPTION_CONTENT_TYPE))
            .andExpect(jsonPath("$.statusDescription").value(Base64Utils.encodeToString(DEFAULT_STATUS_DESCRIPTION)))
            .andExpect(jsonPath("$.statusDate").value(DEFAULT_STATUS_DATE.toString()))
            .andExpect(jsonPath("$.activePhase").value(DEFAULT_ACTIVE_PHASE))
            ...
            .andExpect(jsonPath("$.userTypeDescriptionContentType").value(DEFAULT_USER_TYPE_DESCRIPTION_CONTENT_TYPE))
            .andExpect(jsonPath("$.userTypeDescription").value(Base64Utils.encodeToString(DEFAULT_USER_TYPE_DESCRIPTION)))
            .andExpect(jsonPath("$.userRole").value(DEFAULT_USER_ROLE))
            .andExpect(jsonPath("$.applicationCriteriaContentType").value(DEFAULT_APPLICATION_CRITERIA_CONTENT_TYPE))
            .andExpect(jsonPath("$.applicationCriteria").value(Base64Utils.encodeToString(DEFAULT_APPLICATION_CRITERIA)))
            .andExpect(jsonPath("$.applicationTypeId").value(DEFAULT_APPLICATION_TYPE_ID.intValue()))
            ...
            .andExpect(jsonPath("$.synchedEntityId").value(DEFAULT_SYNCHED_ENTITY_ID.intValue()));
    }
    ...
    public void getAllApplicationsByStatusIsNullOrNotNull() throws Exception {
        ...
        defaultApplicationShouldNotBeFound("status.specified=false");
                ...
                @Test
    @Transactional
    public void getAllApplicationsByStatusContainsSomething() throws Exception {
        // Initialize the database
        applicationRepository.saveAndFlush(application);

        // Get all the applicationList where status contains DEFAULT_STATUS
        defaultApplicationShouldBeFound("status.contains=" + DEFAULT_STATUS);

        // Get all the applicationList where status contains UPDATED_STATUS
        defaultApplicationShouldNotBeFound("status.contains=" + UPDATED_STATUS);
    }

    @Test
    @Transactional
    public void getAllApplicationsByStatusNotContainsSomething() throws Exception {
        // Initialize the database
        applicationRepository.saveAndFlush(application);

        // Get all the applicationList where status does not contain DEFAULT_STATUS
        defaultApplicationShouldNotBeFound("status.doesNotContain=" + DEFAULT_STATUS);

        // Get all the applicationList where status does not contain UPDATED_STATUS
        defaultApplicationShouldBeFound("status.doesNotContain=" + UPDATED_STATUS);
    }
    ...
    public void getAllApplicationsByActivePhaseIsNullOrNotNull() throws Exception {
        ...
        defaultApplicationShouldNotBeFound("activePhase.specified=false");
                ...
                @Test
    @Transactional
    public void getAllApplicationsByActivePhaseContainsSomething() throws Exception {
        // Initialize the database
        applicationRepository.saveAndFlush(application);

        // Get all the applicationList where activePhase contains DEFAULT_ACTIVE_PHASE
        defaultApplicationShouldBeFound("activePhase.contains=" + DEFAULT_ACTIVE_PHASE);

        // Get all the applicationList where activePhase contains UPDATED_ACTIVE_PHASE
        defaultApplicationShouldNotBeFound("activePhase.contains=" + UPDATED_ACTIVE_PHASE);
    }

    @Test
    @Transactional
    public void getAllApplicationsByActivePhaseNotContainsSomething() throws Exception {
        // Initialize the database
        applicationRepository.saveAndFlush(application);

        // Get all the applicationList where activePhase does not contain DEFAULT_ACTIVE_PHASE
        defaultApplicationShouldNotBeFound("activePhase.doesNotContain=" + DEFAULT_ACTIVE_PHASE);

        // Get all the applicationList where activePhase does not contain UPDATED_ACTIVE_PHASE
        defaultApplicationShouldBeFound("activePhase.doesNotContain=" + UPDATED_ACTIVE_PHASE);
    }
    ...
    @Test
    @Transactional
    public void getAllApplicationsByUserIdIsEqualToSomething() throws Exception {
        // Initialize the database
        applicationRepository.saveAndFlush(application);

        // Get all the applicationList where userId equals to DEFAULT_USER_ID
        defaultApplicationShouldBeFound("userId.equals=" + DEFAULT_USER_ID);

        // Get all the applicationList where userId equals to UPDATED_USER_ID
        defaultApplicationShouldNotBeFound("userId.equals=" + UPDATED_USER_ID);
    }

    @Test
    @Transactional
    public void getAllApplicationsByUserIdIsNotEqualToSomething() throws Exception {
        // Initialize the database
        applicationRepository.saveAndFlush(application);

        // Get all the applicationList where userId not equals to DEFAULT_USER_ID
        defaultApplicationShouldNotBeFound("userId.notEquals=" + DEFAULT_USER_ID);

        // Get all the applicationList where userId not equals to UPDATED_USER_ID
        defaultApplicationShouldBeFound("userId.notEquals=" + UPDATED_USER_ID);
    }

    @Test
    @Transactional
    public void getAllApplicationsByUserIdIsInShouldWork() throws Exception {
        // Initialize the database
        applicationRepository.saveAndFlush(application);

        // Get all the applicationList where userId in DEFAULT_USER_ID or UPDATED_USER_ID
        defaultApplicationShouldBeFound("userId.in=" + DEFAULT_USER_ID + "," + UPDATED_USER_ID);

        // Get all the applicationList where userId equals to UPDATED_USER_ID
        defaultApplicationShouldNotBeFound("userId.in=" + UPDATED_USER_ID);
    }

    @Test
    @Transactional
    public void getAllApplicationsByUserIdIsNullOrNotNull() throws Exception {
        // Initialize the database
        applicationRepository.saveAndFlush(application);

        // Get all the applicationList where userId is not null
        defaultApplicationShouldBeFound("userId.specified=true");

        // Get all the applicationList where userId is null
        defaultApplicationShouldNotBeFound("userId.specified=false");
    }

    @Test
    @Transactional
    public void getAllApplicationsByUserIdIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        applicationRepository.saveAndFlush(application);

        // Get all the applicationList where userId is greater than or equal to DEFAULT_USER_ID
        defaultApplicationShouldBeFound("userId.greaterThanOrEqual=" + DEFAULT_USER_ID);

        // Get all the applicationList where userId is greater than or equal to UPDATED_USER_ID
        defaultApplicationShouldNotBeFound("userId.greaterThanOrEqual=" + UPDATED_USER_ID);
    }

    @Test
    @Transactional
    public void getAllApplicationsByUserIdIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        applicationRepository.saveAndFlush(application);

        // Get all the applicationList where userId is less than or equal to DEFAULT_USER_ID
        defaultApplicationShouldBeFound("userId.lessThanOrEqual=" + DEFAULT_USER_ID);

        // Get all the applicationList where userId is less than or equal to SMALLER_USER_ID
        defaultApplicationShouldNotBeFound("userId.lessThanOrEqual=" + SMALLER_USER_ID);
    }

    @Test
    @Transactional
    public void getAllApplicationsByUserIdIsLessThanSomething() throws Exception {
        // Initialize the database
        applicationRepository.saveAndFlush(application);

        // Get all the applicationList where userId is less than DEFAULT_USER_ID
        defaultApplicationShouldNotBeFound("userId.lessThan=" + DEFAULT_USER_ID);

        // Get all the applicationList where userId is less than UPDATED_USER_ID
        defaultApplicationShouldBeFound("userId.lessThan=" + UPDATED_USER_ID);
    }

    @Test
    @Transactional
    public void getAllApplicationsByUserIdIsGreaterThanSomething() throws Exception {
        // Initialize the database
        applicationRepository.saveAndFlush(application);

        // Get all the applicationList where userId is greater than DEFAULT_USER_ID
        defaultApplicationShouldNotBeFound("userId.greaterThan=" + DEFAULT_USER_ID);

        // Get all the applicationList where userId is greater than SMALLER_USER_ID
        defaultApplicationShouldBeFound("userId.greaterThan=" + SMALLER_USER_ID);
    }
    ...
    @Test
    @Transactional
    public void getAllApplicationsByApplicationTypeIdIsEqualToSomething() throws Exception {
        // Initialize the database
        applicationRepository.saveAndFlush(application);

        // Get all the applicationList where applicationTypeId equals to DEFAULT_APPLICATION_TYPE_ID
        defaultApplicationShouldBeFound("applicationTypeId.equals=" + DEFAULT_APPLICATION_TYPE_ID);

        // Get all the applicationList where applicationTypeId equals to UPDATED_APPLICATION_TYPE_ID
        defaultApplicationShouldNotBeFound("applicationTypeId.equals=" + UPDATED_APPLICATION_TYPE_ID);
    }

    @Test
    @Transactional
    public void getAllApplicationsByApplicationTypeIdIsNotEqualToSomething() throws Exception {
        // Initialize the database
        applicationRepository.saveAndFlush(application);

        // Get all the applicationList where applicationTypeId not equals to DEFAULT_APPLICATION_TYPE_ID
        defaultApplicationShouldNotBeFound("applicationTypeId.notEquals=" + DEFAULT_APPLICATION_TYPE_ID);

        // Get all the applicationList where applicationTypeId not equals to UPDATED_APPLICATION_TYPE_ID
        defaultApplicationShouldBeFound("applicationTypeId.notEquals=" + UPDATED_APPLICATION_TYPE_ID);
    }

    @Test
    @Transactional
    public void getAllApplicationsByApplicationTypeIdIsInShouldWork() throws Exception {
        // Initialize the database
        applicationRepository.saveAndFlush(application);

        // Get all the applicationList where applicationTypeId in DEFAULT_APPLICATION_TYPE_ID or UPDATED_APPLICATION_TYPE_ID
        defaultApplicationShouldBeFound("applicationTypeId.in=" + DEFAULT_APPLICATION_TYPE_ID + "," + UPDATED_APPLICATION_TYPE_ID);

        // Get all the applicationList where applicationTypeId equals to UPDATED_APPLICATION_TYPE_ID
        defaultApplicationShouldNotBeFound("applicationTypeId.in=" + UPDATED_APPLICATION_TYPE_ID);
    }

    @Test
    @Transactional
    public void getAllApplicationsByApplicationTypeIdIsNullOrNotNull() throws Exception {
        // Initialize the database
        applicationRepository.saveAndFlush(application);

        // Get all the applicationList where applicationTypeId is not null
        defaultApplicationShouldBeFound("applicationTypeId.specified=true");

        // Get all the applicationList where applicationTypeId is null
        defaultApplicationShouldNotBeFound("applicationTypeId.specified=false");
    }

    @Test
    @Transactional
    public void getAllApplicationsByApplicationTypeIdIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        applicationRepository.saveAndFlush(application);

        // Get all the applicationList where applicationTypeId is greater than or equal to DEFAULT_APPLICATION_TYPE_ID
        defaultApplicationShouldBeFound("applicationTypeId.greaterThanOrEqual=" + DEFAULT_APPLICATION_TYPE_ID);

        // Get all the applicationList where applicationTypeId is greater than or equal to UPDATED_APPLICATION_TYPE_ID
        defaultApplicationShouldNotBeFound("applicationTypeId.greaterThanOrEqual=" + UPDATED_APPLICATION_TYPE_ID);
    }

    @Test
    @Transactional
    public void getAllApplicationsByApplicationTypeIdIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        applicationRepository.saveAndFlush(application);

        // Get all the applicationList where applicationTypeId is less than or equal to DEFAULT_APPLICATION_TYPE_ID
        defaultApplicationShouldBeFound("applicationTypeId.lessThanOrEqual=" + DEFAULT_APPLICATION_TYPE_ID);

        // Get all the applicationList where applicationTypeId is less than or equal to SMALLER_APPLICATION_TYPE_ID
        defaultApplicationShouldNotBeFound("applicationTypeId.lessThanOrEqual=" + SMALLER_APPLICATION_TYPE_ID);
    }

    @Test
    @Transactional
    public void getAllApplicationsByApplicationTypeIdIsLessThanSomething() throws Exception {
        // Initialize the database
        applicationRepository.saveAndFlush(application);

        // Get all the applicationList where applicationTypeId is less than DEFAULT_APPLICATION_TYPE_ID
        defaultApplicationShouldNotBeFound("applicationTypeId.lessThan=" + DEFAULT_APPLICATION_TYPE_ID);

        // Get all the applicationList where applicationTypeId is less than UPDATED_APPLICATION_TYPE_ID
        defaultApplicationShouldBeFound("applicationTypeId.lessThan=" + UPDATED_APPLICATION_TYPE_ID);
    }

    @Test
    @Transactional
    public void getAllApplicationsByApplicationTypeIdIsGreaterThanSomething() throws Exception {
        // Initialize the database
        applicationRepository.saveAndFlush(application);

        // Get all the applicationList where applicationTypeId is greater than DEFAULT_APPLICATION_TYPE_ID
        defaultApplicationShouldNotBeFound("applicationTypeId.greaterThan=" + DEFAULT_APPLICATION_TYPE_ID);

        // Get all the applicationList where applicationTypeId is greater than SMALLER_APPLICATION_TYPE_ID
        defaultApplicationShouldBeFound("applicationTypeId.greaterThan=" + SMALLER_APPLICATION_TYPE_ID);
    }
    ...
    @Test
    @Transactional
    public void getAllApplicationsBySynchedEntityIdIsEqualToSomething() throws Exception {
        // Initialize the database
        applicationRepository.saveAndFlush(application);

        // Get all the applicationList where synchedEntityId equals to DEFAULT_SYNCHED_ENTITY_ID
        defaultApplicationShouldBeFound("synchedEntityId.equals=" + DEFAULT_SYNCHED_ENTITY_ID);

        // Get all the applicationList where synchedEntityId equals to UPDATED_SYNCHED_ENTITY_ID
        defaultApplicationShouldNotBeFound("synchedEntityId.equals=" + UPDATED_SYNCHED_ENTITY_ID);
    }

    @Test
    @Transactional
    public void getAllApplicationsBySynchedEntityIdIsNotEqualToSomething() throws Exception {
        // Initialize the database
        applicationRepository.saveAndFlush(application);

        // Get all the applicationList where synchedEntityId not equals to DEFAULT_SYNCHED_ENTITY_ID
        defaultApplicationShouldNotBeFound("synchedEntityId.notEquals=" + DEFAULT_SYNCHED_ENTITY_ID);

        // Get all the applicationList where synchedEntityId not equals to UPDATED_SYNCHED_ENTITY_ID
        defaultApplicationShouldBeFound("synchedEntityId.notEquals=" + UPDATED_SYNCHED_ENTITY_ID);
    }

    @Test
    @Transactional
    public void getAllApplicationsBySynchedEntityIdIsInShouldWork() throws Exception {
        // Initialize the database
        applicationRepository.saveAndFlush(application);

        // Get all the applicationList where synchedEntityId in DEFAULT_SYNCHED_ENTITY_ID or UPDATED_SYNCHED_ENTITY_ID
        defaultApplicationShouldBeFound("synchedEntityId.in=" + DEFAULT_SYNCHED_ENTITY_ID + "," + UPDATED_SYNCHED_ENTITY_ID);

        // Get all the applicationList where synchedEntityId equals to UPDATED_SYNCHED_ENTITY_ID
        defaultApplicationShouldNotBeFound("synchedEntityId.in=" + UPDATED_SYNCHED_ENTITY_ID);
    }

    @Test
    @Transactional
    public void getAllApplicationsBySynchedEntityIdIsNullOrNotNull() throws Exception {
        // Initialize the database
        applicationRepository.saveAndFlush(application);

        // Get all the applicationList where synchedEntityId is not null
        defaultApplicationShouldBeFound("synchedEntityId.specified=true");

        // Get all the applicationList where synchedEntityId is null
        defaultApplicationShouldNotBeFound("synchedEntityId.specified=false");
    }

    @Test
    @Transactional
    public void getAllApplicationsBySynchedEntityIdIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        applicationRepository.saveAndFlush(application);

        // Get all the applicationList where synchedEntityId is greater than or equal to DEFAULT_SYNCHED_ENTITY_ID
        defaultApplicationShouldBeFound("synchedEntityId.greaterThanOrEqual=" + DEFAULT_SYNCHED_ENTITY_ID);

        // Get all the applicationList where synchedEntityId is greater than or equal to UPDATED_SYNCHED_ENTITY_ID
        defaultApplicationShouldNotBeFound("synchedEntityId.greaterThanOrEqual=" + UPDATED_SYNCHED_ENTITY_ID);
    }

    @Test
    @Transactional
    public void getAllApplicationsBySynchedEntityIdIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        applicationRepository.saveAndFlush(application);

        // Get all the applicationList where synchedEntityId is less than or equal to DEFAULT_SYNCHED_ENTITY_ID
        defaultApplicationShouldBeFound("synchedEntityId.lessThanOrEqual=" + DEFAULT_SYNCHED_ENTITY_ID);

        // Get all the applicationList where synchedEntityId is less than or equal to SMALLER_SYNCHED_ENTITY_ID
        defaultApplicationShouldNotBeFound("synchedEntityId.lessThanOrEqual=" + SMALLER_SYNCHED_ENTITY_ID);
    }

    @Test
    @Transactional
    public void getAllApplicationsBySynchedEntityIdIsLessThanSomething() throws Exception {
        // Initialize the database
        applicationRepository.saveAndFlush(application);

        // Get all the applicationList where synchedEntityId is less than DEFAULT_SYNCHED_ENTITY_ID
        defaultApplicationShouldNotBeFound("synchedEntityId.lessThan=" + DEFAULT_SYNCHED_ENTITY_ID);

        // Get all the applicationList where synchedEntityId is less than UPDATED_SYNCHED_ENTITY_ID
        defaultApplicationShouldBeFound("synchedEntityId.lessThan=" + UPDATED_SYNCHED_ENTITY_ID);
    }

    @Test
    @Transactional
    public void getAllApplicationsBySynchedEntityIdIsGreaterThanSomething() throws Exception {
        // Initialize the database
        applicationRepository.saveAndFlush(application);

        // Get all the applicationList where synchedEntityId is greater than DEFAULT_SYNCHED_ENTITY_ID
        defaultApplicationShouldNotBeFound("synchedEntityId.greaterThan=" + DEFAULT_SYNCHED_ENTITY_ID);

        // Get all the applicationList where synchedEntityId is greater than SMALLER_SYNCHED_ENTITY_ID
        defaultApplicationShouldBeFound("synchedEntityId.greaterThan=" + SMALLER_SYNCHED_ENTITY_ID);
    }
    ...
    public void updateApplication() throws Exception {
        ...
        assertThat(testApplication.getStatusDescriptionContentType()).isEqualTo(UPDATED_STATUS_DESCRIPTION_CONTENT_TYPE);
        ...
        assertThat(testApplication.getUserTypeDescriptionContentType()).isEqualTo(UPDATED_USER_TYPE_DESCRIPTION_CONTENT_TYPE);
        ...
        assertThat(testApplication.getApplicationCriteriaContentType()).isEqualTo(UPDATED_APPLICATION_CRITERIA_CONTENT_TYPE);
        assertThat(testApplication.getApplicationTypeId()).isEqualTo(UPDATED_APPLICATION_TYPE_ID);
        ...
        assertThat(testApplication.getSynchedEntityId()).isEqualTo(UPDATED_SYNCHED_ENTITY_ID);
    }
