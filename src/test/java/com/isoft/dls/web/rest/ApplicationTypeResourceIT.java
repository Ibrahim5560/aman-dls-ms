...
public class ApplicationTypeResourceIT {
    ...
    public void checkDescriptionIsRequired() throws Exception {
        int databaseSizeBeforeTest = applicationTypeRepository.findAll().size();
        // set the field null
        applicationType.setDescription(null);
    ...
    public void checkSummaryIsRequired() throws Exception {
        int databaseSizeBeforeTest = applicationTypeRepository.findAll().size();
        // set the field null
        applicationType.setSummary(null);
    ...
    @Test
    @Transactional
    public void getAllApplicationTypesByDescriptionIsEqualToSomething() throws Exception {
        // Initialize the database
        applicationTypeRepository.saveAndFlush(applicationType);

        // Get all the applicationTypeList where description equals to DEFAULT_DESCRIPTION
        defaultApplicationTypeShouldBeFound("description.equals=" + DEFAULT_DESCRIPTION);

        // Get all the applicationTypeList where description equals to UPDATED_DESCRIPTION
        defaultApplicationTypeShouldNotBeFound("description.equals=" + UPDATED_DESCRIPTION);
    }

    @Test
    @Transactional
    public void getAllApplicationTypesByDescriptionIsNotEqualToSomething() throws Exception {
        // Initialize the database
        applicationTypeRepository.saveAndFlush(applicationType);

        // Get all the applicationTypeList where description not equals to DEFAULT_DESCRIPTION
        defaultApplicationTypeShouldNotBeFound("description.notEquals=" + DEFAULT_DESCRIPTION);

        // Get all the applicationTypeList where description not equals to UPDATED_DESCRIPTION
        defaultApplicationTypeShouldBeFound("description.notEquals=" + UPDATED_DESCRIPTION);
    }

    @Test
    @Transactional
    public void getAllApplicationTypesByDescriptionIsInShouldWork() throws Exception {
        // Initialize the database
        applicationTypeRepository.saveAndFlush(applicationType);

        // Get all the applicationTypeList where description in DEFAULT_DESCRIPTION or UPDATED_DESCRIPTION
        defaultApplicationTypeShouldBeFound("description.in=" + DEFAULT_DESCRIPTION + "," + UPDATED_DESCRIPTION);

        // Get all the applicationTypeList where description equals to UPDATED_DESCRIPTION
        defaultApplicationTypeShouldNotBeFound("description.in=" + UPDATED_DESCRIPTION);
    }

    @Test
    @Transactional
    public void getAllApplicationTypesByDescriptionIsNullOrNotNull() throws Exception {
        // Initialize the database
        applicationTypeRepository.saveAndFlush(applicationType);

        // Get all the applicationTypeList where description is not null
        defaultApplicationTypeShouldBeFound("description.specified=true");

        // Get all the applicationTypeList where description is null
        defaultApplicationTypeShouldNotBeFound("description.specified=false");
    }
                @Test
    @Transactional
    public void getAllApplicationTypesByDescriptionContainsSomething() throws Exception {
        // Initialize the database
        applicationTypeRepository.saveAndFlush(applicationType);

        // Get all the applicationTypeList where description contains DEFAULT_DESCRIPTION
        defaultApplicationTypeShouldBeFound("description.contains=" + DEFAULT_DESCRIPTION);

        // Get all the applicationTypeList where description contains UPDATED_DESCRIPTION
        defaultApplicationTypeShouldNotBeFound("description.contains=" + UPDATED_DESCRIPTION);
    }

    @Test
    @Transactional
    public void getAllApplicationTypesByDescriptionNotContainsSomething() throws Exception {
        // Initialize the database
        applicationTypeRepository.saveAndFlush(applicationType);

        // Get all the applicationTypeList where description does not contain DEFAULT_DESCRIPTION
        defaultApplicationTypeShouldNotBeFound("description.doesNotContain=" + DEFAULT_DESCRIPTION);

        // Get all the applicationTypeList where description does not contain UPDATED_DESCRIPTION
        defaultApplicationTypeShouldBeFound("description.doesNotContain=" + UPDATED_DESCRIPTION);
    }


    @Test
    @Transactional
    public void getAllApplicationTypesBySummaryIsEqualToSomething() throws Exception {
        // Initialize the database
        applicationTypeRepository.saveAndFlush(applicationType);

        // Get all the applicationTypeList where summary equals to DEFAULT_SUMMARY
        defaultApplicationTypeShouldBeFound("summary.equals=" + DEFAULT_SUMMARY);

        // Get all the applicationTypeList where summary equals to UPDATED_SUMMARY
        defaultApplicationTypeShouldNotBeFound("summary.equals=" + UPDATED_SUMMARY);
    }

    @Test
    @Transactional
    public void getAllApplicationTypesBySummaryIsNotEqualToSomething() throws Exception {
        // Initialize the database
        applicationTypeRepository.saveAndFlush(applicationType);

        // Get all the applicationTypeList where summary not equals to DEFAULT_SUMMARY
        defaultApplicationTypeShouldNotBeFound("summary.notEquals=" + DEFAULT_SUMMARY);

        // Get all the applicationTypeList where summary not equals to UPDATED_SUMMARY
        defaultApplicationTypeShouldBeFound("summary.notEquals=" + UPDATED_SUMMARY);
    }

    @Test
    @Transactional
    public void getAllApplicationTypesBySummaryIsInShouldWork() throws Exception {
        // Initialize the database
        applicationTypeRepository.saveAndFlush(applicationType);

        // Get all the applicationTypeList where summary in DEFAULT_SUMMARY or UPDATED_SUMMARY
        defaultApplicationTypeShouldBeFound("summary.in=" + DEFAULT_SUMMARY + "," + UPDATED_SUMMARY);

        // Get all the applicationTypeList where summary equals to UPDATED_SUMMARY
        defaultApplicationTypeShouldNotBeFound("summary.in=" + UPDATED_SUMMARY);
    }

    @Test
    @Transactional
    public void getAllApplicationTypesBySummaryIsNullOrNotNull() throws Exception {
        // Initialize the database
        applicationTypeRepository.saveAndFlush(applicationType);

        // Get all the applicationTypeList where summary is not null
        defaultApplicationTypeShouldBeFound("summary.specified=true");

        // Get all the applicationTypeList where summary is null
        defaultApplicationTypeShouldNotBeFound("summary.specified=false");
    }
                @Test
    @Transactional
    public void getAllApplicationTypesBySummaryContainsSomething() throws Exception {
        // Initialize the database
        applicationTypeRepository.saveAndFlush(applicationType);

        // Get all the applicationTypeList where summary contains DEFAULT_SUMMARY
        defaultApplicationTypeShouldBeFound("summary.contains=" + DEFAULT_SUMMARY);

        // Get all the applicationTypeList where summary contains UPDATED_SUMMARY
        defaultApplicationTypeShouldNotBeFound("summary.contains=" + UPDATED_SUMMARY);
    }

    @Test
    @Transactional
    public void getAllApplicationTypesBySummaryNotContainsSomething() throws Exception {
        // Initialize the database
        applicationTypeRepository.saveAndFlush(applicationType);

        // Get all the applicationTypeList where summary does not contain DEFAULT_SUMMARY
        defaultApplicationTypeShouldNotBeFound("summary.doesNotContain=" + DEFAULT_SUMMARY);

        // Get all the applicationTypeList where summary does not contain UPDATED_SUMMARY
        defaultApplicationTypeShouldBeFound("summary.doesNotContain=" + UPDATED_SUMMARY);
    }
