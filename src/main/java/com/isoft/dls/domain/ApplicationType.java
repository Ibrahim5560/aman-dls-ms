...
public class ApplicationType implements Serializable {
    ...
    public ApplicationType applications(Set<Application> applications) {
        this.applications = applications;
        return this;
    }

    public ApplicationType addApplication(Application application) {
        this.applications.add(application);
        application.setApplicationType(this);
        return this;
    }

    public ApplicationType removeApplication(Application application) {
