...
/**
 * A VM of User Inbox Search Request API.
 */
@ApiModel(description = "User Inbox Search Request VM. @author Rami Nassar.")
@JsonInclude(JsonInclude.Include.NON_EMPTY)
public class UserInboxSearchRequestVM {
    ...
    public String toString() {
        return "UserInboxSearchRequestVM{" +
                "pageSize=" + pageSize +
                ", offset=" + offset +
